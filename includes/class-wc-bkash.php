...
class WC_bKash
{
    ...
    public function transaction_form_order_view($order)
    {
     ...
     * @return object
     */
    public function do_request($transaction_id)
    {
     ...
     * @return void
     */
    public function insert_transaction($response)
    {
        global $wpdb;
    ...
    public function transaction_exists($transaction_id)
    {
        ...
        $query = $wpdb->prepare("SELECT * FROM {$wpdb->prefix}{$this->table} WHERE trxId = %s", $transaction_id);
